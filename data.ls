...
base.data = do
  aux:
    ...
    cover:
      ...
      muggle: zh: "專為<b>不懂程式</b>的新聞工作者設計", en: "For Journalists Who <b>DON'T</b> Code"
    sessions: zh: "議程表", en: "Sessions"
    registration: zh: "報名 NT$2980 <br><small>(7/24 截止)</small>", en: "Registration <br><small> ( till Jul 24 ) </small>"
  ...
  navbar:
    * link: "http://dbootcamp.taipei", target: "_self",  zh: "台北，台灣", en: "Taipei, Taiwan"
